...
const FamCard = ({ img, name, branch, hall, mail, linkedIn, graduated }) => (
  <motion.div
    whileHover={{ scale: 1.01 }}
    className="relative flex flex-col justify-around items-center p-2 md:p-3 lg:p-4 border border-gray-400 dark:border-gray-900 
               bg-gradient-to-tr from-gray-100 dark:from-gray-700 to-gray-200 dark:to-gray-800 
               rounded-2xl gap-1 md:gap-2 shadow-sm hover:shadow-red-200 dark:hover:shadow-gray-500 
  ...
  >
    ...
    <div className="flex justify-between items-center gap-4 w-full">
      <p className="text-sm md:text-lg text-gray-900 dark:text-gray-400">{branch}</p>
      <p className="text-sm md:text-lg text-gray-900 dark:text-gray-400">{hall}</p>
    </div>
